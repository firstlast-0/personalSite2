                ...
                <div className="main">
                    ...
                    <div className="projects">
                        ...
                        <div className="project">
                            ...
                            <div>This React project simulates the shopping cart feature on e-commerce websites</div>
                            <div className="links">
                                <div>
                                    <img src={eye} className="icon" alt="eye" />
                        ...
                        <div className="project">
                            ...
                            <div>This React project which utilizes an external API allows users to play a memory game</div>
                            <div className="links">
                                <div>
                                    <img src={eye} className="icon" alt="eye" />
                    ...
                    <br />
                    For a complete list, visit my <a href="https://github.com/firstlast-0" target='_blank' rel="noreferrer">Github</a>
                </div>
